  ...
  implements JsonRepresentedObject, Cloneable, Iterable<MessagePart>, ConfigurationSerializable
{
  ...
  public FancyMessage translationReplacements(FancyMessage... replacements)
  {
    ...
    int j = (arrayOfFancyMessage = replacements).length;
    for (int i = 0; i < j; i++)
    {
      FancyMessage str = arrayOfFancyMessage[i];
    ...
    throws IllegalArgumentException, IllegalAccessException, InstantiationException, InvocationTargetException, NoSuchMethodException, ClassNotFoundException
  {
    if (nmsChatSerializerGsonInstance == null)
    {
      ...
      if ((majorVersion < 1.8D) || ((majorVersion == 1.8D) && (lesserVersion == 1))) {
...
public static FancyMessage deserialize(String json)
  {
    ...
    for (JsonElement mPrt : extra)
    {
      ...
      {
        Map.Entry<String, JsonElement> compositeNestedElement;
		...
		Map<String, Object> serializedMapForm = new HashMap<String, Object>();
          ...
          if (((JsonElement)entry.getValue()).isJsonPrimitive()) {
            ...
            for (Iterator<Entry<String, JsonElement>> localIterator3 = ((JsonElement)entry.getValue()).getAsJsonObject().entrySet().iterator(); localIterator3.hasNext();)
            {
              compositeNestedElement = (Map.Entry<String, JsonElement>)localIterator3.next();
